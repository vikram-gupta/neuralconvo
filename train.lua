...
cmd:option('--prepareSourceTargetSeparately', false, 'prepare source and target separately')
...
dataset = neuralconvo.DataSet(neuralconvo.CornellMovieDialogs("data/cornell_movie_dialogs"),
                    {
                      ...
                      prepareSourceTargetSeparately = options.prepareSourceTargetSeparately
                    })
